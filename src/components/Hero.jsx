...
const Hero = () => {
  ...
  const upcommingVdeoI = (currentIndex % totalVideos) + 1;

  const handleMiniVdClick = ()=>{
     setHasClicked(true);

     setCurrentIndex(upcommingVdeoI)
  }
      ...
      <div id="video-frame" className='relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75'>
        <div>
            <div className='mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg' >
              <div onClick={handleMiniVdClick} className='origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100'>
                <video 
                 ref={nextVidRef} 
                 src={getVideoSrc(upcommingVdeoI)}
                 loop
                 muted
                 id='current-video'
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">Enter the Metagame Layer <br />Unlish the Play Economy</p>
